...
export const industryItems: NavDropdownItem[] = [
  ...
  { label: "Power, Energy & Utilities", href: "/jobs?industry=power-plant" },
  { label: "Water & Wastewater Treatment", href: "/jobs?industry=water-treatment" },
  { label: "Construction, Infrastructure & EPC Projects", href: "/jobs?industry=construction" },
  { label: "Manufacturing & Industrial Production", href: "/jobs?industry=manufacturing" },
  { label: "Facility Management, MEP & Maintenance", href: "/jobs?industry=facility-management" },
  { label: "Healthcare & Medical Services", href: "/jobs?industry=healthcare" },
  { label: "IT, Software, Hardware & Telecom", href: "/jobs?industry=it" },
  { label: "Marine & Shipping Services", href: "/jobs?industry=marine" },
  { label: "Banking, Financial Services & Insurance", href: "/jobs?industry=banking-finance" },
  { label: "HR & Administration", href: "/jobs?industry=hr-admin" },
  { label: "Logistics, Transportation & Supply Chain", href: "/jobs?industry=logistics" },
  { label: "FMCG & Consumer Goods", href: "/jobs?industry=fmcg" },
  { label: "Engineering, Design & Technical Consultancy", href: "/jobs?industry=design-engineering" },
